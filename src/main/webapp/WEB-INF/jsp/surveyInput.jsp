...
<form:form method="POST" action="${submitFormUrl}"
	...
	<div class="survey">
		...
		<div class="formInputGroup">
			...
			<div class="formInputGroup">
		     <div class="row">
				<form:label path="activityLevel" id="activity">Activity Level: </form:label>
				
				 <input type="radio" id="inactive" name="activityLevel" value="inactive"> 
					<label for="activityLevel" class="radio2">Inactive</label>
					
				    <input type="radio" id="sedentary" name="activityLevel" value="sedentary" > 
					<label for="activityLevel" class="radio2">Sedentary</label>
					
				    <input type="radio" id="active" name="activityLevel" value="active" >
				    <label for="activityLevel" class="radio2">Active</label> 
				    
				    <input type="radio" id="exactive" name="activityLevel" value="exactive">
				    <label for="activityLevel" class="radio2">Extremely Active</label>
				    
				<form:errors path="activityLevel" />
			</div>
		</div>

	<input class="btn btn-danger target" type="submit" value="Submit" />
	</div>
